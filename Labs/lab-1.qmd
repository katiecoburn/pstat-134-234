...
Our textbook uses `IPython` rather than `reticulate` through RStudio. If you prefer, you can use `IPython` instead. However, **all material for this course is written by me, using `reticulate`, Anaconda, RStudio, and Quarto, with a combination of R and Python code chunks.**
